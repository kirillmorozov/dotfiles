...
abbr -a jjblc --description='list conflicted bookmarks' -- 'jj bookmark list --conflicted'
abbr -a jjblt --description='list tracked bookmarks' -- 'jj bookmark list --tracked'
...
abbr -a jjf --description='update files with fixes' -- 'jj fix'
