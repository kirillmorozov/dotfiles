...
-- [[ Configure plugins ]]
-- NOTE: Here is where you install your plugins. You can configure plugins
-- using the `config` key.
--
--  You can also configure plugins after the setup call, as they will be
  ...
  -- Fuzzy Finder (files, lsp, etc)
  {
    ...
    dependencies = {
      ...
      -- requirements installed.
      {
        ...
        -- NOTE: If you are having trouble with this installation, refer to the
        -- README for telescope-fzf-native for more instructions.
        build = 'make',
        cond = function()
